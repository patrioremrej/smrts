...
BOT_TOKEN = getenv("BOT_TOKEN", "7853877617:AAEGA7xLZIv0FJiXbvd2pCyXNlNs9PL1vLI") #8419506999:AAGHxYoprCCZIc1Cam2bk0ecHRiwLl9gkJw
...
LOG_GROUP = getenv("LOG_GROUP", "-1002867430238")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1002879768901"))
