<h1 align="center">
  Latest Release Version Two Still Some Bugs In 30 Sites Download Upload
</h1>

# Important Note : 
- Now Updated link : https://github.com/abirxdhack/RestrictedContentDL

[Telegram](https://t.me/ModVip_rm) | [See Recent Updates](https://github.com/abirxdhack/RestrictedContentDL)

### Live Bot Here
See Our Live Bot On Telegram [ᴘʀɪᴠᴀᴛᴇ ᴄᴏɴᴛᴇɴᴛ ғᴏʀᴡᴀʀᴅᴇʀ ʙᴏᴛ](https://t.me/savecontentsfxcbot)
...
[![Deploy Heroku](https://www.herokucdn.com/deploy/button.svg)](https://www.heroku.com/deploy/?template=https://github.com/abirxdhack/RestrictedContentDL)
...
- **`OWNER_ID`**: Use [@ItsSmartToolBot](https://t.me/missrose_bot) to get your user ID by sending `/info`.
