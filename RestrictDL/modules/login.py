...
import asyncio
import string
from RestrictDL.core.mongo import db
from RestrictDL.core.func import subscribe, chk_user
...
async def generate_session(_, message):
    ...
    number = await _.ask(user_id, 'Please enter your phone number along with the country code.Note This Is Safe Session Gen But Use Responsively \nExample: +19876543210', filters=filters.text)   
    ...
    try:
        ...
        try:
            ...
            await two_step_msg.reply('❌Invalid 2FA Pass Please Restart Procedeure')
            return
    string_session = await client.export_session_string()
    await db.set_session(user_id, string_session)
    await client.disconnect()
    await otp_code.reply("✅ Login successful! From Now You Will Be Able To DL From Private Chats")
