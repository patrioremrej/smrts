...
from RestrictDL import app
import aiofiles
from RestrictDL import sex as gf
...
if STRING:
    from RestrictDL import pro
    print("App imported from RestrictDL.")
else:
    pro = None
        ...
        if 't.me/c/' in msg_link or 't.me/b/' in msg_link:
            ...
            if chat in saved_channel_ids:
                await app.edit_message_text(
                    ...
                    "Sorry! This channel is protected by **__@abirxdhackz__**."
                )
                return
...
async def clone_message(app, msg, target_chat_id, topic_id, edit_id, log_group):
    ...
    RestrictDLin = await app.send_message(target_chat_id, msg.text.markdown, reply_to_message_id=topic_id)
    await RestrictDLin.copy(log_group)
    await edit.delete()
...
get_user_rename_preference = lambda user_id: user_rename_preferences.get(str(user_id), '@abirxdhackz')
...
async def send_settings_message(chat_id, user_id):
    ...
    buttons = [
        ...
        [Button.url("Report Errors", "https://t.me/ModVip_rm")]
    ]
...
async def callback_query_handler(event):
    ...
    if event.data == b'setchat':
        ...
        await event.edit("Choose your preferred upload method:\n\n__**Note:** **Telethon ⚡**, built on Telethon(base), by @abirxdhackz still in beta.__", buttons=buttons)
    ...
    try:
        ...
        if freecheck == 1:
            reply_markup = InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("💎 Get Premium to Forward", url="https://t.me/abirxdhackz")]
                ]
            )
